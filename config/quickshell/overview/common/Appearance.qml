...
Singleton {
    ...
    // NB: "Appearance.colors.qml" n'existe pas dans ce repo (jamais généré/vendu).
    // Tant que useMatugenColors reste à false (défaut), ce Loader ne s'active jamais.
    // Le passer à true sans fournir ce fichier cassera le chargement.
    Loader {
        id: matugenLoader
