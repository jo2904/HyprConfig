...
PanelWindow {
    ...
    property bool anchorToButton: true  // false = centrer sur l'écran
    ...
    anchors {
        top: anchorToButton
        left: anchorToButton && anchorSide === "left"
        right: anchorToButton && anchorSide === "right"
    }

    margins {
        top: anchorToButton ? Config.barHeight + 10 : 0
        left: anchorToButton && anchorSide === "left" ? 10 : 0
        right: anchorToButton && anchorSide === "right" ? 10 : 0
    }

    implicitWidth: anchorToButton ? popupWidth + (screenMargin * 2) : screen?.width ?? 1920
    implicitHeight: anchorToButton ? popupMaxHeight : screen?.height ?? 1080
    color: "transparent"
    ...
    Item {
        ...
        Rectangle {
            ...
            transformOrigin: root.anchorToButton ? (root.anchorSide === "left" ? Item.TopLeft : Item.TopRight) : Item.Top
